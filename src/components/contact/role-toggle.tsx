...
> = {
  investor: {
    label: "Investors",
    tag: "FOR INVESTORS",
    title: "Invest in research-driven technology development",
    desc: "Discuss prototype development, validation milestones, IP strategy, and the planned route to commercial operation.",
  ...
  researcher: {
    ...
    title: "Collaborate with Depth X research",
    desc: "We welcome defined collaborations for experimental validation and evidence-building across our research domains.",
  ...
  company: {
    ...
    desc: "Explore specialist development, future pilot work, or operating a validated technology under license.",
