...
> = {
  investor: {
    label: "Investors",
    tag: "FOR INVESTORS",
    title: "Explore the technology roadmap and commercialization pathway",
    desc: "Speak directly with our team about research progress, IP strategy, prototype engineering, and future commercialization opportunities.",
