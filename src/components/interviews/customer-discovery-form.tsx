...
const translations = {
  en: {
    ...
    conceptDescription: "DepthX is developing an autonomous aerial marketing platform designed to combine mobile advertising with anonymous audience measurement and real-time campaign adaptation.",
  ...
  de: {
    ...
    conceptDescription: "DepthX entwickelt eine autonome Luftmarketing-Plattform, die mobile Werbung mit anonymer Publikumsmessung und Echtzeit-Anpassung von Kampagnen verbinden soll.",
  ...
  zh: {
    ...
    conceptDescription: "DepthX 正在开发一个自主空中营销平台，将移动广告与匿名受众测量和实时活动调整结合起来。",
...
const categoryQuestions: Record<Lang, Record<InterviewType, QuestionSpec[]>> = {
  en: {
    ...
    A: [
      ...
      { key: "a9_service_offering", prompt: "Could you imagine offering DepthX as part of your services to clients?", kind: "yesNo" },
  ...
  de: {
    ...
    A: [
      ...
      { key: "a9_service_offering", prompt: "Könnten Sie sich vorstellen, DepthX als Teil Ihres Leistungsangebots für Kunden anzubieten?", kind: "yesNo" },
  ...
  zh: {
    ...
    A: [
      ...
      { key: "a9_service_offering", prompt: "您能想象将 DepthX 作为面向客户的服务之一吗？", kind: "yesNo" },
