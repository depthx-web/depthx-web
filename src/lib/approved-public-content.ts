export const APPROVED_HERO = {
  headline: "Researching technologies.",
  accent: "Building protected systems. Preparing them for market.",
  description:
  ...
  stage: "PATENT-PENDING · PRE-PROTOTYPE · ENGINEERING BUILD NEXT",
};
