...
insert into projects (
  ...
  'This is the first commercialization priority: a patent-pending autonomous multi-UAV platform at the pre-prototype stage, with the engineering build as the next milestone.',
   null, 'emQopter GmbH is an external engineering collaborator supporting the planned prototype engineering phase.',
